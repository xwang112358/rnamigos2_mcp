...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_combined_objective', action='store_true',
    ...
    parser.add_argument('--similarity_weight', type=float, default=0.3,
                        help='Weight for similarity objective (default: 0.3)')
    parser.add_argument('--binding_weight', type=float, default=0.7,
    ...
    if args.use_combined_objective:
        ...
        print(f"Using combined objective: binding_weight={args.binding_weight}, similarity_weight={args.similarity_weight}")
